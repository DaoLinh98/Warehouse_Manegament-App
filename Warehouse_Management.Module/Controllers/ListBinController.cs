...
namespace Warehouse_Management.Module.Controllers
{
    ...
    public partial class ListBinController : ViewController
    {
        public ListBinController()
        {
            InitializeComponent();
            // Target required Views (via the TargetXXX properties) and create their Actions.
            this.TargetObjectType = typeof(ListBin);
        }
        ...
        private void ImportListBin_Execute(object sender, SimpleActionExecuteEventArgs e)
        {
            ConnectionInfo connect_String = new ConnectionInfo();
            connect_String.ConnectionString = AppConfig.connectStr;
            connect_String.QueryString = @"SELECT * FROM [ListBins]";
            ...
            excelImportObjects.Add(new ExcelImportObject("ListBinName", "ListBinName", ExcelColType.COL_STRING, 100, false, false));

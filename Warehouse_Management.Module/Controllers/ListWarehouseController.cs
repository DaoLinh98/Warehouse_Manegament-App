...
namespace Warehouse_Management.Module.Controllers
{
    ...
    public partial class ListWarehouseController : ViewController
    {
        public ListWarehouseController()
        {
            InitializeComponent();
            // Target required Views (via the TargetXXX properties) and create their Actions.
            this.TargetObjectType = typeof(ListWarehouse);
        }
        ...
        private void ImportListWarehouse_Execute(object sender, SimpleActionExecuteEventArgs e)
        {
            ConnectionInfo connect_String = new ConnectionInfo();
            connect_String.ConnectionString = AppConfig.connectStr;
            connect_String.QueryString = @"SELECT * FROM [ListWarehouses]";
            ...
            excelImportObjects.Add(new ExcelImportObject("WarehouseName", "WarehouseName", ExcelColType.COL_STRING, 100, false, false));

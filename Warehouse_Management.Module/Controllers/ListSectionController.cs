...
namespace Warehouse_Management.Module.Controllers
{
    ...
    public partial class ListSectionController : ViewController
    {
        public ListSectionController()
        {
            InitializeComponent();
            // Target required Views (via the TargetXXX properties) and create their Actions.
            this.TargetObjectType = typeof(ListSection);
        }
        ...
        private void ImportListSection_Execute(object sender, SimpleActionExecuteEventArgs e)
        {
            ConnectionInfo connect_String = new ConnectionInfo();
            connect_String.ConnectionString = AppConfig.connectStr;
            connect_String.QueryString = @"SELECT * FROM [ListSections]";
            ...
            excelImportObjects.Add(new ExcelImportObject("ListSectionName", "ListSectionName", ExcelColType.COL_STRING, 100, false, false));

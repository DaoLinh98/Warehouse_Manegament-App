...
namespace Warehouse_Management.Module {
    // For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.ModuleBase.
    public sealed partial class Warehouse_ManagementModule : ModuleBase {
        static Warehouse_ManagementModule() {
            ...
            // #if DEBUG
            // Database.SetInitializer(new DropCreateDatabaseIfModelChanges<Warehouse_ManagementDbContext>());
            // #endif 
        }
        public Warehouse_ManagementModule() {
            InitializeComponent();
